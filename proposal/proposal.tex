...
\noindent\textbf{Team members:} Xuyang Wang, Shreyas Phegade\\
...
Inference stays on our workstation (RTX~5070, 16\,GB), with models loaded one at a time, using free assets such as Freedoom.
...
\begin{itemize}
  ...
  \item Stage~2 layout generation from text briefs via Ollama (\texttt{qwen3-coder} family); concept-image stub or a first local diffusion pass if VRAM allows.
